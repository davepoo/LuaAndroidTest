...
VIMPORT IVisPlugin_cl* GetEnginePlugin_LuaSwigTestEnginePlugin();

class LuaSwigTestApp : public VAppImpl
{
public:
  LuaSwigTestApp() {}
  virtual ~LuaSwigTestApp() {}
...
VAPP_IMPLEMENT_SAMPLE(LuaSwigTestApp);

void LuaSwigTestApp::SetupAppConfig(VisAppConfig_cl& config)
{
  ...
  */
  ...
  config.m_videoConfig.m_szWindowTitle = "LuaSwigTest";

  config.m_videoConfig.m_bWaitVRetrace = true;
}

void LuaSwigTestApp::PreloadPlugins()
{
  ...
  VISION_PLUGIN_ENSURE_LOADED(LuaSwigTestEnginePlugin);
}

//---------------------------------------------------------------------------------------------------------
// Init function. Here we trigger loading our scene
//---------------------------------------------------------------------------------------------------------
void LuaSwigTestApp::Init()
{
...
//---------------------------------------------------------------------------------------------------------
void LuaSwigTestApp::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool LuaSwigTestApp::Run()
{
  return true;
}

void LuaSwigTestApp::DeInit()
{
  // De-Initialization
  // [...]
}
