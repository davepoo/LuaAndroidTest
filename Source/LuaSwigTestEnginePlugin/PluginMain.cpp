...
#include "LuaSwigTestEnginePluginPCH.h"
...
//============================================================================================================
class LuaSwigTestEnginePlugin : public IVisPlugin_cl
{
public:
  ...
  {
    return "LuaSwigTestEnginePlugin";  // must match DLL name
  }
};

//  global plugin instance
LuaSwigTestEnginePlugin g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_LuaSwigTestEnginePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_LuaSwigTestEnginePlugin();}
...
void LuaSwigTestEnginePlugin::OnInitEnginePlugin()
{
  hkvLog::Info("LuaSwigTestEnginePlugin:OnInitEnginePlugin()");
...
void LuaSwigTestEnginePlugin::OnDeInitEnginePlugin()
{
  hkvLog::Info("LuaSwigTestEnginePlugin:OnDeInitEnginePlugin()");
